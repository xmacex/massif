Engine_ResonatorBank : CroneEngine {
  ...
  *new { arg context, doneCallback;
  ...
  alloc {
    SynthDef(\resonatorbank, {|inL, inR, out, amp=0.1, offset=0,
      ...
      var freqs = [freq1 + offset, freq2 + offset, freq3 + offset, freq4 + offset, freq5 + offset, freq6 + offset, freq7 + offset, freq8 + offset];
...
// commands
    ...
    this.addCommand("offset", "f", {|msg|
      synth.set(\offset, msg[1]);
    });
